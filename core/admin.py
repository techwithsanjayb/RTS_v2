...
class ZoneAdmin(admin.ModelAdmin):
    list_display = ("name", "code", "system", "is_active", "created_at", "updated_at")
    list_filter = ("system", "is_active")
    search_fields = ("name", "code", "system__name")
...
class DivisionAdmin(admin.ModelAdmin):
    list_display = ("name", "code", "zone", "is_active", "created_at", "updated_at")
